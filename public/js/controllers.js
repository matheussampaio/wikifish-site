...
wfApp.controller("wfIndexCtrl", function ($scope) {
    ...
    $scope.vm.options = [{
        ...
        title: "Alimentação",
        values: [{ title: "Dry, packaged food", "enum": "DRY_PACKAGE_FOOD", value: true }, { title: "Live fish", "enum": "LIVE_FISH", value: true }, { title: "Live worms, Daphnia, etc.", "enum": "LIVE_WORMS", value: true }, { title: "Vegetarian", "enum": "VEGETARIAN", value: true }]
    }, {
        name: "reproduction__in",
        title: "Reprodução",
        values: [{ title: "Egglayer", "enum": "EGGYLAYER", value: true }, { title: "Livebearer", "enum": "LIVEBEARER", value: true }, { title: "Mouthbrooder", "enum": "MOUTHBROODER", value: true }]
    }];
});
...
wfApp.controller("wfSearchCtrl", function ($scope, $routeParams, FishService, $location) {
    $scope.vm = {};
